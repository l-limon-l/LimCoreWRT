...
**LimCore** is a modern multi-core proxy platform for OpenWrt created by **l_limon_l**. Built on top of [sing-box-extended](https://github.com/singbox/sing-box-extended) and [sing-box-extended](https://github.com/shtorm-7/sing-box-extended).

### 🚀 Features
- **Multi-Core Engine**: Run on sing-box-extended or **sing-box-extended** with automatic hardware-aware build selection.
...
- **Subscription Support**: Import nodes from VLESS, VMess, Trojan, Shadowsocks, WireGuard, AmneziaWG, and Xray/singbox subscriptions.
...
**LimCore** — современная многоядерная прокси-платформа для OpenWrt от автора **l_limon_l**. Работает на базе [sing-box-extended](https://github.com/singbox/sing-box-extended) и [sing-box-extended](https://github.com/shtorm-7/sing-box-extended).

### 🚀 Возможности
- **Многоядерный движок**: Выбор между sing-box-extended и **sing-box-extended** с автоподбором сборки под память устройства.
...
- **Поддержка подписок**: Импорт VLESS, VMess, Trojan, Shadowsocks, WireGuard, AmneziaWG и подписок singbox/Xray.
