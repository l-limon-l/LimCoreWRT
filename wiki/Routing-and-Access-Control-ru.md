...
| **Пользовательский JSON** | Конфиг sing-box вручную — см. [Пользовательский JSON конфиг](Custom-JSON-Config-ru). |
...
- Используйте страницу [Диагностика](DNS-and-Diagnostics-ru), чтобы убедиться, что трафик реально проксируется — смотрите строку **Активный узел**.
