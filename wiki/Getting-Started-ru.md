...
- sing-box-extended (по умолчанию) — легче, есть компактная сборка для маленьких роутеров.
...
- **Проверка соединения** — проверяет доступность тестовых сайтов. На sing-box-extended показывает ваш **IP провайдера** против **IP прокси** (при проксировании они должны различаться); на **sing-box-extended** вместо этого показывает **Активный узел** (sing-box не может сообщить исходящий IP).
