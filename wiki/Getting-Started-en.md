...
This page walks you from a fresh install to a working connection. It assumes LimCore is already installed (see the [README](../../blob/master/README.md) for package installation).

> Everything below is done in the LuCI web UI: **Services → LimCore**.
...
Back on the **Client** page, set **Main node** to the node you added — or choose **URLTest** to let LimCore automatically pick and fail over to the fastest reachable node.
