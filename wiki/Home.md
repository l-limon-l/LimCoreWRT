...
| [Core Management](Core-Management-en) | Choosing sing-box-extended vs sing-box-extended, the smart installer, storage and the compact build |
...
| [Custom JSON Config](Custom-JSON-Config-en) | Using the Custom JSON routing mode with raw sing-box-extended config |
...
| [Управление ядром](Core-Management-ru) | Выбор sing-box-extended или sing-box-extended, умный установщик, память и компактная сборка |
...
| [Пользовательский JSON конфиг](Custom-JSON-Config-ru) | Использование режима «Пользовательский JSON» с конфигом sing-box-extended |
