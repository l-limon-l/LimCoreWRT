...
| [Core Management](Core-Management-en) | The sing-box-extended core, the guarded installer, storage requirements and custom binaries |
...
| [Custom JSON Config](Custom-JSON-Config-en) | Using the Custom JSON routing mode with a raw sing-box config |
...
| [Управление ядром](Core-Management-ru) | Ядро sing-box-extended, установщик с проверками, требования к памяти и своё ядро |
...
| [Пользовательский JSON конфиг](Custom-JSON-Config-ru) | Использование режима «Пользовательский JSON» с «сырым» конфигом sing-box |
