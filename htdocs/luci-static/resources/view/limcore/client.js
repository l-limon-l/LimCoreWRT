...
function renderStatus(isRunning, features) {
	...
	let renderHTML;
	if (isRunning)
		renderHTML = spanTemp.format('green', _('LimCore'), coreStr, _('RUNNING'));
	else
		renderHTML = spanTemp.format('red', _('LimCore'), coreStr, _('NOT RUNNING'));
...
return view.extend({
	...
	render(data) {
		...
		m = new form.Map('limcore', _('LimCore'),
		...
		o = s.taboption('control', form.SectionValue, '_control', form.NamedSection, 'control', 'limcore');
		ss = o.subsection;
