	...
	render: function(devices) {
		...
		return E('div', { 'class': 'cbi-map' }, [
			...
			E('div', { 'class': 'cbi-map-descr' },
				_('Pause or restore internet access for any device on the network.<br>A paused device stays connected and still reaches the router, but nothing of it goes out to the internet.')),
